        ...
        <div class="row">
            <div class="col-sm-6 text-black">
                ...
                <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                    ...
                    <form method="post" action="index.php?controller=customer&action=loginProcess" style="width: 23rem;">
                        ...
                        <a href="index.php?controller=customer&action=register"><p>Chưa có tài khoản? </p><b>Đăng ký</b></a>
                    </form>
