...
<form class="formCreate" action="index.php?controller=customer&action=store" method="POST" enctype="multipart/form-data">
    ...
    <br>
    <input type="text" id="customerPass" name="customerPass" required>
    <br>
    <br>
