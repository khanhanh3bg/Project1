...
foreach ($array['orders'] as $order){
    ...
    <form class="formCreate" action="index.php?controller=order&action=update" method="POST" enctype="multipart/form-data">
        ...
        <br>
        <input type="date" value="<?= $order['Order_date'] ?>" id="orderDate" name="orderDate" required>
        <br>
